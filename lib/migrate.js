...
const reverseSequelizeDefValueType = function(defaultValue, prefix = 'Sequelize.')
{
    ...
    return { value: defaultValue } // needs to return raw value because of this check here https://github.com/sequelize/sequelize/blob/18cc7b01f08d4dc82e1b6144262c55f3fe252d6a/lib/sql-string.js#L64
};
...
const reverseModels = function(sequelize, models)
{
    ...
    for (let model in models)
    {
        ...
        for (let column in attributes)
        {
            ...
            attributes[column]['type'] = seqType;
